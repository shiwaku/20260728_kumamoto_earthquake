...
地殻変動は読みやすい順に **2.5次元解析**（上下・東西の成分に分解済み。色がそのまま変動量）→
...
1レイヤーあたり約8件で、SAR を6枚とも ON にすると比例して増える
...
- **変位境界（亀裂分布）八代地区** … 7/31公開だが[PDF](https://www.gsi.go.jp/chirijoho/chirijoho41071.html)
