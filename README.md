...
| 被害状況 | 斜面崩壊・土石流・堆積分布（八代地区） | GeoJSON（21面） | 国土地理院 | |
| 被害状況 | 斜面崩壊・堆積分布 熊本3地区 | GeoJSON（7面） | 国土地理院 | |
| 被害状況 | 斜面崩壊・堆積分布 熊本1地区 | GeoJSON（3面） | 国土地理院 | |
| 被害状況 | 斜面崩壊・堆積分布 熊本2地区 | GeoJSON（2面） | 国土地理院 | |
| 被害状況 | 斜面崩壊・堆積分布 熊本4地区 | GeoJSON（4面＋雲21面） | 国土地理院 | |
| 被害状況 | 斜面崩壊・堆積分布 熊本県央地区 | GeoJSON（12面） | 国土地理院 | |
| 被害状況 | 道路規制（7/31 7:30時点） | GeoJSON（同梱・62区間） | 国土交通省 | |
| 空中写真 | 正射画像 八代地区 7/29撮影 | ラスタタイル | 国土地理院 | |
| 空中写真 | 正射画像 熊本3地区 7/31・8/1撮影 | ラスタタイル | 国土地理院 | |
| 空中写真 | 正射画像 熊本1地区 8/3撮影 | ラスタタイル | 国土地理院 | |
| 空中写真 | 正射画像 熊本2地区 7/29・8/2撮影 | ラスタタイル | 国土地理院 | |
| 空中写真 | 正射画像 熊本4地区 7/30撮影 | ラスタタイル | 国土地理院 | |
| 空中写真 | 正射画像（速報）熊本県央地区 8/12撮影 | ラスタタイル | 国土地理院 | |
| 空中写真 | 垂直写真（速報）八代地区 7/29撮影 | GeoJSON（点・513枚） | 国土地理院 | |
| 空中写真 | 垂直写真 八代地区 7/29撮影 | GeoJSON（点・451枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本1地区 7/29撮影 | GeoJSON（点・127枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本1地区 8/3撮影 | GeoJSON（点・127枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本2地区 7/29撮影 | GeoJSON（点・201枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本2地区 8/2撮影 | GeoJSON（点・201枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本3地区 7/29撮影 | GeoJSON（点・114枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本3地区 7/30撮影 | GeoJSON（点・558枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本3地区 7/31撮影 | GeoJSON（点・558枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本3地区 8/1撮影 | GeoJSON（点・558枚） | 国土地理院 | |
| 空中写真 | 垂直写真 熊本4地区 7/30撮影 | GeoJSON（点・202枚） | 国土地理院 | |
| 空中写真 | 垂直写真（速報）熊本県央地区 8/12撮影 | GeoJSON（点・438枚） | 国土地理院 | |
| 空中写真 | 斜め写真 八代地区 7/29撮影 | GeoJSON（点・567枚） | 国土地理院 | |
| 空中写真 | 斜め写真 熊本4地区 7/29撮影 | GeoJSON（点・140枚） | 国土地理院 | |
| 地殻変動 | 変位境界（SAR判読 8/5暫定） | GeoJSON（同梱・25本） | 国土地理院（判読）／JAXA | |
| 地殻変動 | 変位境界（写真・DSM判読 8/7速報） | ラスタタイル（同梱・z9-13） | 国土地理院 地理地殻活動研究センター | |
| 地殻変動 | SAR 2.5次元解析 準上下成分 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR 2.5次元解析 準東西成分 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR アンラップ画像 だいち4号 7/2〜7/30 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR アンラップ画像 だいち2号 2025/8/12〜7/28 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR干渉画像 だいち4号 7/2〜7/30 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR干渉画像 だいち2号 2025/8/12〜7/28 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR干渉画像 だいち4号→2号 7/11〜7/31 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR干渉画像 だいち2号→4号 5/15〜8/1 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR干渉画像 だいち4号→2号 2025/11/13〜7/29 | ラスタタイル | 国土地理院（解析）／JAXA | |
| 地殻変動 | SAR干渉画像 だいち2号 2024/12/20〜7/31 | ラスタタイル | 国土地理院（解析）／JAXA | |
...
配信元が CORS を返すレイヤーは実行時に直接参照し、同梱は[6つだけ](#同梱データ)。

同じ地区を日を変えて何度も撮影しているため、垂直写真は地区×撮影日で1レイヤーずつ持っている
（熊本3地区は7/29・7/30・7/31・8/1の4回）。日付を切り替えると同じ場所の変化を追える。

地殻変動は読みやすい順に **変位境界**（判読済みの線。どこが切れているかだけを見るならこれ）→
**2.5次元解析**（上下・東西の成分に分解済み。色がそのまま変動量）→
**アンラップ画像**（縞を積算した視線方向の絶対量）→ **干渉画像**（生の縞模様。縞を数えて読む）。
まず2.5次元解析を見て、細部を干渉画像で確かめるのが早い。

干渉画像は6枚ある。同じ地殻変動でも、衛星の進行方向（北行／南行）と電波の照射方向（右／左）が違うと
縞の出方が変わるので、配信元の凡例も組み合わせごとに別になっている。
6枚のうち3枚はだいち2号と4号をまたぐペアで、名前は「1回目→2回目」の衛星で書いている。
...
| 国土地理院「[衛星画像解析による変位境界（速報）](https://www.gsi.go.jp/uchusokuchi/uchusokuchi41008.html)」 | `www.gsi.go.jp/common/000279979.zip`（GeoJSON 1本。**CORS を返さない**ので同梱） |
| 国土地理院「[画像と数値表層モデルから判読された変位境界（速報）](https://www.gsi.go.jp/chirijoho/chirijoho41073.html)」 | `gisstar.gsi.go.jp/R8kumamoto/Figures(GeoTIFF).zip`（**ベクタの配信は無く図の GeoTIFF 4枚だけ**。図1から線を抜いて同梱） |
...
| 翌朝もまだ開いたまま | 巡回が「対応するか、対応不要なら閉じるか」を Issue にコメントする。同じ Issue への再通知は7日おき。閾値は日ではなく20時間（起票は巡回の所要時間ぶん後ろにずれるので、24時間だと翌朝を取りこぼす） |
...
直接参照できない・しないほうがよい6つだけを `viewer/public/data/` に置いている。
...
| 変位境界（SAR判読）<br>25本・7.5KB | 配信元が `www.gsi.go.jp` の ZIP で CORS を返さない。座標が空の26地物を落として線色を付けている | `tools/build_displacement_boundary.py` |
| 変位境界（写真・DSM判読）<br>z9-z13・32タイル・24KB | 配信元はベクタを出しておらず、成果物は PDF と背景・凡例まで入った「図」の GeoTIFF だけ。図1から赤線を色で抜いて透過タイルに焼いている | `tools/build_displacement_boundary_dsm.py` |
...
- **変位境界は51地物のうち26地物の座標が空**（判読作業の残骸とみられる）。属性は `id` だけで一意でもなく、
  空の地物とも値を共有する。位置の誤差が数10〜100m あるため、配信元は縮尺の目安をズームレベル15以下としている
...
| 垂直写真は表から生成 | 地区×撮影日で12レイヤーあり、違うのは配信元IDと説明文だけ。同じ内容を12回書かない | `layers.ts` `SUICHOKU_SET` |
| SAR干渉画像は精密暦版（`_precise`）を参照 | 配信元が精密暦・大気／電離層補正を入れた版に置き換えた。旧版はまだ配信されているがレイヤー一覧から外れている | `layers.ts` `sar-alos*` |
| 正射画像 八代地区は正式版 | 速報版は速報用カメラの暫定成果。正式版は航空カメラ（UCE）から作り直したもので、斜面崩壊の判読にも使われている | `layers.ts` `ortho` |
| 正射画像 熊本1地区は防災ページに出る前から収録 | レイヤー定義には載っていて配信も始まっているが、防災ページの「正射画像」の節にはまだ出ていない（8/6時点） | `layers.ts` `ortho-k1` |
| 変位境界は公表図の黒ではなくマゼンタ | ダークテーマと空中写真も背景に取るため。SAR干渉画像の bcyr 系配色には無い色相なので縞とも混ざらない | `layers.ts` `henni`、`tools/build_displacement_boundary.py` |
| 変位境界は活断層図・主要活断層帯より前面（`z: 36`） | 干渉画像に重ねて読む線なので、参照用の断層線に隠されると意味がない | `layers.ts` `henni` |
| 写真・DSM判読の変位境界はベクタに起こさずラスタのまま | 配信は「図」の GeoTIFF だけ。図1は南半分が実線・北半分が破線で、破線を繋ぐと配信元が引いていない連続性を足すことになる。判読自体が数10mの誤差を含む速報値なので、約22 m/px のラスタのほうが精度を偽らない | `tools/build_displacement_boundary_dsm.py` |
| 写真・DSM判読の変位境界だけ既定の不透明度が 0.6 | 公表図の線は地上換算で約65m 幅あり、拡大すると下の空中写真を隠す。透かして重ねられるようにしてある | `layers.ts` `henni-dsm` |
...
1レイヤーあたり数件〜10件程度で、SAR のラスタ10枚を全部 ON にすると比例して増える
（ストリップが斜めに走るので、矩形の `bounds` では穴を塞げない）。
...
- **空中写真から判読した変位境界（八代地区）** … 7/31公開の[PDF](https://www.gsi.go.jp/chirijoho/chirijoho41071.html)
  だけで、タイルも GeoJSON も配信されていない。8/7公開の後続レポート（写真・DSM判読）が
  八代市から御船町までを扱っていて、こちらは図から線を抜いて収録済みなので、
  八代地区だけの前報は入れていない
- **写真・DSM判読の変位境界のずれ量（図2〜図4）** … 右横ずれ量・縦ずれ量を地点ごとに色と数値で
  示した図。色は抜き出せるが、肝心の数値は黒文字で背景の注記と区別が付かず、
  凡例の階級（0.0〜2.2m）だけを塗った点レイヤーにしても数値が読めない。
  変位境界の線（図1）だけを収録し、ずれ量は[レポート本体](https://www.gsi.go.jp/chirijoho/chirijoho41073.html)へ誘導している
- **地理院地図（中・小縮尺タイル）リニューアル版**（標準 `std_renewal_test`：8/5にZL14、8/10にZL9〜13。
  淡色 `pale_renewal_test`：8/13にZL9〜14） …
  災害データではなく背景地図の試作版（正式公開は令和8年9月末予定）なので入れていない。
  ズームが広がっても淡色版が増えても判断は同じ
